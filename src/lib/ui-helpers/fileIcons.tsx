...
const artwork = {
    ...
    help: line('M10 1.5a8.5 8.5 0 1 1 0 17 8.5 8.5 0 0 1 0-17 M7.5 7.6a2.5 2.5 0 1 1 3.4 2.3c-.6.3-.9.8-.9 1.5v.6') + disk(10, 15, 1.2),
    ...
    tauri: disk(7,7,5) + '<g color="#0891B2">' + disk(13,13,5) + '</g>',
    ...
    'color-palette': solid('M10 1a9 9 0 1 0 0 18h1a2 2 0 0 0 1-3.5 1.5 1.5 0 0 1 1-2.5h2a4 4 0 0 0 4-4c0-4.5-4-8-9-8 M6 4a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3 M11 3a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3 M15 6a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3 M4 9a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3') + '<g color="#ef4444">' + disk(6,5.5,1.5) + '</g><g color="#f59e0b">' + disk(11,4.5,1.5) + '</g><g color="#22c55e">' + disk(15,7.5,1.5) + '</g><g color="#3b82f6">' + disk(4,10.5,1.5) + '</g>',
